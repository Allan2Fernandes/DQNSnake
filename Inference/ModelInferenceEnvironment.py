...
class SnakeEnvironment:
    def __init__(self, x_blocks, y_blocks, block_size, device, num_episodes, max_time_steps, batch_size, render_mode, model_path):
        ...
        self.deep_Q_network = torch.load(model_path)
        pygame.init()
    ...
    def game_loop(self):
        ...
        for episode in range(self.num_episodes):
            ...
            while not done:
                ...
                # TODO PRODUCE ACTION HERE
                Q_values = self.deep_Q_network(state)[0]
            ...
            pass
        print("Average Score = {0} for model: {1}".format(np.average(running_scores), self.model_path))
        pass
